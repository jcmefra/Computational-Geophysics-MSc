...
for w in tqdm(range(0,100)):
    ...
    T=10 
    temp1=(np.random.rand(1,1)*0.019 + paso1) #[0.001-0.02]
    temp2=(np.random.rand(1,1)*9 +paso2) #[1-10] 
...
ax.plot_trisurf(muestreo_plot_arr[:,0], muestreo_plot_arr[:,1], muestreo_plot_arr[:,2], edgecolor='none', alpha =.25, antialiased = True)
